...
namespace ClassJournalProject.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_StudentEducationLevels_StudentEducationLevelId",
                        column: x => x.StudentEducationLevelId,
                        principalTable: "StudentEducationLevels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_StudentStatuses_StudentStatusId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_StudentStatusId",
                table: "AspNetUsers",
